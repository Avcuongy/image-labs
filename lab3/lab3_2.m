...
figure;
subplot(1,4,1); imshow(cmyk(:,:,1), []); title('C');
subplot(1,4,2); imshow(cmyk(:,:,2), []); title('M');
subplot(1,4,3); imshow(cmyk(:,:,3), []); title('Y');
subplot(1,4,4); imshow(cmyk(:,:,4), []); title('K');
...
subplot(1,4,2); imshow(xyz);
subplot(1,4,3); imshow(hsv);
subplot(1,4,4); imshow(lab);
